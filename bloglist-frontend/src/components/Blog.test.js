...
test("renders only author and title", () => {
  ...
  const element = screen.getByText(
    "Title: Component testing is done with react-testing-library. Author: true."
  )
    ...
    container = render(
      <Togglable buttonLabel="View details">
        <div className="testDiv">
          Title: Component testing is done with react-testing-library. Author:
          true. Url: yes. Likes: 55
        </div>
      </Togglable>
    ).container
  })
